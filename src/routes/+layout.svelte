...
<svelte:head>
	...
	<meta name="og:title" content="asmocore.eu" />
	<meta property="og:description" content="AsmoCore.eu" />
	<meta name="twitter:image" itemprop="image" content="/Asmo.webp" />
	<meta name="twitter:card" content="summary" />
	<meta name="theme-color" content="#CCE2F2" />
	<title>asmocore.eu</title>
</svelte:head>
